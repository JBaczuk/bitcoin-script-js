const opcodes = require('../../src/util/opcodes')
const {
  opcodeForWord,
  wordForOpcode,
  opcodeIsValid,
...
describe('opcodes', function () {
  describe('.opcodeForWord', function () {
    ...
    it('throws if the word is invalid', function () {
      expect(() => opcodeForWord('OP_CLONE')).to.throw('Not a valid term')
    })
  })
  ...
  describe('.wordForOpcode', function () {
    ...
    it('throws if the opcode does not exist', function () {
      expect(() => wordForOpcode(257)).to.throw('Not a valid opcode')
      expect(() => wordForOpcode(-1)).to.throw('Not a valid opcode')
    })
  ...
  describe('.descriptionForOpcode', function () {
    ...
    it('throws if the term does not exist', function () {
      expect(() => descriptionForOpcode(257)).to.throw('Not a valid opcode')
    })
  })
  ...
  describe('.descriptionForWord', function () {
    ...
    it('throws if the word is invalid', function () {
      expect(() => descriptionForWord('OP_CLONE')).to.throw('Not a valid term')
    })
  })
  ...
  describe('.inputDescriptionForOpcode', function () {
    ...
    it('throws if the opcode does not exist', function () {
      expect(() => inputDescriptionForOpcode(257)).to.throw('Not a valid opcode')
    })
  })
  ...
  describe('.inputDescriptionForWord', function () {
    ...
    it('throws if the term does not exist', function () {
      expect(() => inputDescriptionForWord('OP_CLONE')).to.throw('Not a valid term')
    })
  })
  ...
  describe('.outputDescriptionForOpcode', function () {
    ...
    it('throws if the opcode does not exist', function () {
      expect(() => outputDescriptionForOpcode(257)).to.throw('Not a valid opcode')
    })
  })
  ...
  describe('.outputDescriptionForWord', function () {
    ...
    it('throws if the term does not exist', function () {
      expect(() => outputDescriptionForWord('OP_CLONE')).to.throw('Not a valid term')
    })
  })
  ...
  describe('.opcodeIsDisabled', function () {
    ...
    it('throws if the opcode does not exist', function () {
      expect(() => opcodeIsDisabled(257)).to.throw('Not a valid opcode')
    })
  })
  ...
  describe('.wordIsDisabled', function () {
    ...
    it('throws if the term does not exist', function () {
      expect(() => wordIsDisabled(257)).to.throw('Not a valid term')
    })
  })
})
